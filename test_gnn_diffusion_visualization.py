...
def main():
    ...
    parser.add_argument('-d', '--dirs', default='/media/jtorde/T7/gdp/evals-dir/evals3/tmp_dagger/2/demos/', help='directory', type=str)
    ...
    max_num_training_demos = 10000 if not is_test_run else 100          # max number of training demonstrations
    ...
    # load model
    dir = "/media/jtorde/T7/gdp/models/model5"
